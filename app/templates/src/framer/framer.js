...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Importer = (function() {
	  ...
	  Importer.prototype._createLayer = function(info, superLayer) {
	    var LayerClass, i, layer, layerInfo, len, ref, ref1, ref2, suffix;
	    if (info.layerFrame) {
	    ...
	    for (i = 0, len = ref2.length; i < len; i++) {
	      suffix = ref2[i];
	      if (_.endsWith(layerInfo.name, suffix)) {
	        layerInfo.name = layerInfo.name.replace(suffix, "");
	      }
	      if (_.endsWith(layerInfo.name.toUpperCase(), suffix)) {
	        layerInfo.name = layerInfo.name.replace(suffix.toUpperCase(), "");
	      }
	    }
	  ...
	  Importer.prototype._correctArtboards = function(layers) {
	    var i, layer, len, points, results;
	    points = [];
	    results = [];
	    for (i = 0, len = layers.length; i < len; i++) {
	      layer = layers[i];
	      if (layer._info.kind === "artboard") {
	        ...
	        layer.visible = true;
	        results.push(points.push(layer.point));
	      } else {
	        results.push(void 0);
	      }
	    }
...
/***/ function(module, exports) {
	...
	exports.date = 1450345559;
	
	exports.branch = "master";
	
	exports.hash = "920106e";
